...
% Last Modified by GUIDE v2.5 16-Jul-2015 16:56:06
...
% --- Executes on button press in animationArrow.
function animationArrow_Callback(hObject, eventdata, handles)
% hObject    handle to animationArrow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of animationArrow
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
value = get(handles.animationArrow, 'Value')
